...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/ramraj/catkin_ws_copy/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/ramraj/catkin_ws_copy/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/ramraj/catkin_ws_copy/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ramraj <ramraj@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ramraj/catkin_ws_copy/src/beginner_tutorials/${idir}'.  Ask the maintainer 'ramraj <ramraj@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ramraj/catkin_ws_copy/devel/lib;/opt/ros/kinetic/lib)
